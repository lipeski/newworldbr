...
class Strapi extends Hookable {
  constructor (ctx) {
    ...
    this.$http.setBaseURL(runtimeConfig.url || 'https://api-newworldbr.herokuapp.com')
...
export default async function (ctx, inject) {
  [{"name":"articles","type":"collection"},{"name":"categories","type":"collection"},{"name":"homepage","type":"single"},{"name":"global","type":"single"}].forEach((entity) => {
  let key
  let type = 'collection'
